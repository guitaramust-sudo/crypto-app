...
> **Note:** Проект создан в образовательных целях для демонстрации навыков работы с асинхронными запросами, типизацией на TypeScript и современными методами управления состоянием приложения.
